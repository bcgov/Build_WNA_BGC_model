...
Y <- addVars(Y)
# 
load("./BGC_models/WNA_Subzone_17Var_extratree.Rdata")
...
st_write(t2, dsn = paste0("./outputs/", region, "_", "SubZoneMap_hex400_dissolved2.gpkg"), layer = paste0(region, "_", timeperiod, "_", covcount, "_vars_gini"), driver = "GPKG", delete_layer = TRUE)
