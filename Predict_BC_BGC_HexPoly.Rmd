...
# X1.pred <- X2
# X1.pred$BGC <- predict(BGCmodel, newdata = X1.pred)
...
st_write(t2, dsn = paste0("./outputs/", region, "_", "SubZoneMap_hex400_dissolved2.gpkg"), layer = paste0(region, "_", timeperiod, "_", covcount, "_new_BioClim"), driver = "GPKG", delete_layer = TRUE)
