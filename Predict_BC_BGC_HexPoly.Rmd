...
Y <- addVars(Y)
# 
load("./outputs/WNAv11_35_VAR_SubZone_ranger.Rdata")
...
write.csv(model_vars, "./outputs/35Var_WNABGCv11.csv", row.names = FALSE)
...
#st_write(temp2, dsn = "./outputs/RSC_SubZoneMap_400m_undissolved_16June2020.gpkg", driver = "GPKG", delete_dsn = TRUE)
...
st_write(t2, dsn = paste0("./outputs/", region, "_", "SubZoneMap_hex400_dissolved.gpkg"), layer = paste0(region, "_", timeperiod, "_", covcount, "_vars"), driver = "GPKG", delete_layer = TRUE)
