...
wna_bgc <- vect("../WNA_BGC/WNA_BGC_v12_5Apr2022.gpkg")

coords <- fread("../WNA_BGC/WNA_2km_grid_WHM.csv")
...
fwrite(coords2, "../WNA_BGC/WNA_2km_grid_KSD.csv")
...
# pts <- vect(coords, geom = c("long","lat"), crs = "epsg:4326")
# writeVector(pts,"Will_Pts.gpkg")

setcolorder(coords, c("long","lat","elev","id"))
coords <- as.data.frame(coords) #%>% dplyr::filter(elev >-1)
