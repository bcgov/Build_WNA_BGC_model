...
## load ranger model
load("./BGC_models/WNAv12_Subzone_24_Var_ranger_MuchReduced2.Rdata")
...
st_write(t2, dsn = paste0("./outputs/", covcount, "_", "Subzone_Map_hex400_dissolved.gpkg"), layer = paste0(region, "_", timeperiod, "_", region , "_vars_ranger_muchreduced"), driver = "GPKG", delete_layer = TRUE)
