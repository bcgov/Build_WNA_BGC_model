...
## load ranger model
load("./BGC_models/WNAv12_Subzone_92_Var_ranger_reduced4.Rdata")
...
write.csv(BGC_area, paste0("./outputs/", region, "_", timeperiod, "_", covcount, "_BGC_area_predicted_reduced_4e.csv"))
st_write(t2, dsn = paste0("./outputs/", covcount, "_", "Subzone_Map_hex400_dissolved.gpkg"), layer = paste0(region, "_", timeperiod, "_", region , "_vars_ranger_reduced_4e"), driver = "GPKG", delete_layer = TRUE)
