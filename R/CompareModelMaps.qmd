...
```{r}
#| echo: false
mod1 <- vect("../../Common_Files/ModelMaps/WA_BGC_9Jan2024_eliminated_papervar_balanced.gpkg")
mod2 <- vect("../../Common_Files/ModelMaps/WA_BGC_11Jan2024_xgboost_papervar_unbalanced.gpkg")
test1 <- compare_maps(mod1,mod2)
plot(test1$map)
test1[["summary"]][,.(value, count, Prop)]
```
