...
BGCmodel
save(BGCmodel,file="./BGC_models/WNA_Subzone_17Var_extratree.Rdata")
...
write.csv (BGCmodel$variable.importance, file= paste("./outputs/",fname,"_Importance_xtra",model,".csv",sep=""))
