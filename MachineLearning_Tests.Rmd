...
params <- list(booster = "gbtree", objective = "multi:softmax", eta=0.1, gamma=3, max_depth=8,
               min_child_weight=1, subsample=0.75, colsample_bytree=1,num_class = 362)
